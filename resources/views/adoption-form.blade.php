        ...
        <div class="flex items-center">
          ...
          <div class="ml-3">
            <p class="text-sm text-gray-800">
              <span class="font-semibold">{{ $pet->archive_reason === 'Pet has passed away' ? 'This pet is deceased. ' : '' }}This pet has been archived and is no longer available for adoption.</span>
