<x-layout>
  ...
  <section class="py-20 bg-gray-50 dark:bg-gray-900">
    <div class="max-w-screen-xl mx-auto px-4 md:px-8">
      <a href="/services/adopt-a-pet" class="text-blue-500 font-bold hover:text-orange-500 text-lg flex items-center">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-2 overflow-hidden">
        ...
        <div class="p-6">
          ...
          <form method="POST" action="/services/{{ $pet->slug }}/adoption-form">
            ...
            <div id="alert-3"
              class="flex items-center p-4 my-3 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 sm:col-span-7"
              role="alert">
              <svg class="shrink-0 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                viewBox="0 0 20 20">
                <path
