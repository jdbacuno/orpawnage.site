<x-admin-layout>
  ...
  <div class="bg-white p-6 shadow-md rounded-lg mt-4">
    ...
    <div id="alert-3"
      class="flex items-center p-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 sm:col-span-7 edit-success w-full md:w-1/2"
      role="alert">
          ...
          <tr class="bg-gray-100 text-gray-700">
            ...
            <th class="py-2 px-4 text-left">
              <a href="{{ request()->fullUrlWithQuery(['sort' => 'breed', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}"
                class="text-blue-500 hover:underline hover:text-blue-600 flex items-center gap-1 whitespace-nowrap">
                Breed <span>{!! request('sort') === 'breed' ? (request('direction') === 'asc' ? '▲' : '▼') : ''
                  !!}</span>
              </a>
            </th>
            <th class="py-2 px-4 text-left">
