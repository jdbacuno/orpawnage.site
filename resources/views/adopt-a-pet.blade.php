        ...
        <div class="my-6 p-6 bg-gray-50/80 backdrop-blur-lg rounded-lg border border-yellow-500">
          <div class="flex items-center justify-between flex-wrap gap-3">
            ...
            <div class="flex space-x-2 overflow-x-auto scrollbar-hidden" id="language-tabs">
              <button data-tab="english" class="tab-btn bg-white px-3 py-1 rounded border border-yellow-400 text-black font-medium hover:bg-yellow-300 active">English</button>
              <button data-tab="tagalog" class="tab-btn bg-white px-3 py-1 rounded border border-yellow-400 text-black font-medium hover:bg-yellow-300">Taglish</button>
              <button data-tab="kapampangan" class="tab-btn bg-white px-3 py-1 rounded border border-yellow-400 text-black font-medium hover:bg-yellow-300">Kapampangan</button>
            </div>
          </div>
            ...
            <div id="tab-content-english" class="tab-content">
              <div class="space-y-2">
                ...
                <li class="pb-2 border-b border-blue-100">
                        <span class="font-medium">Complete this form</span> with accurate personal information and adoption details.
                </li>
                    </ol>
                  </div>
                </details>
                <details class="process-step" data-step="2">
                  ...
                  <div class="p-3 text-sm text-gray-700">
                    <ol class="list-decimal list-inside space-y-2 leading-7">
                <li class="pb-2 border-b border-blue-100">
                        After submission, you'll receive a <span class="font-medium">confirmation email that you need to confirm within 24 hours</span>.
                        <span class="text-red-400 font-medium">Failure to confirm within this period will automatically cancel your application.</span>
                </li>
                    </ol>
                  </div>
                </details>
                <details class="process-step" data-step="3">
                  ...
                  <div class="p-3 text-sm text-gray-700">
                    <ol class="list-decimal list-inside space-y-2 leading-7">
                <li class="pb-2 border-b border-blue-100">
                        Once confirmed, you'll receive another email with the estimated preparation time for your pet. Please wait for the <span class="font-medium">scheduling email</span> to proceed.
                </li>
                    </ol>
                  </div>
                </details>
                <details class="process-step" data-step="4">
                  ...
                  <div class="p-3 text-sm text-gray-700">
                    <ol class="list-decimal list-inside space-y-2 leading-7">
                <li class="pb-2 border-b border-blue-100">
                        When you receive the scheduling email, you must <span class="font-medium">set a pickup date within 48 hours</span>.
                        <span class="text-red-400 font-medium">No response within this timeframe will cancel your application.</span> Available dates will be within 7 business days from the scheduling email date.
                </li>
                    </ol>
                  </div>
                </details>
                ...
                <li class="pb-2 border-b border-blue-100">
                  ...
                  <ul class="list-disc list-inside ml-5 mt-1">
                    ...
                    <li>Your transaction confirmation email</li>
                        ...
                        <span class="text-red-400 font-medium">Failure to pick up within 3 business days after your scheduled date will cancel the adoption.</span>
                </li>
                    </ol>
                  </div>
                </details>
                <details class="process-step" data-step="6">
                  ...
                  <div class="p-3 text-sm text-gray-700">
                    <ol class="list-decimal list-inside space-y-2 leading-7">
                      <li>
                        At pickup, we'll take <span class="font-medium">an official photo</span> of you with your new pet holding an adoption information board. This may be shared on the City Information Office's official channels.
                </li>
              </ol>
                  </div>
                </details>
              ...
              <div class="space-y-2">
                <details class="process-step" data-step="1" open>
                  ...
                  <div class="p-3 text-sm text-gray-700">
                    <ol class="list-decimal list-inside space-y-2 leading-7">
                <li class="pb-2 border-b border-blue-100">
                        <span class="font-medium">Kumpletuhin ang form na ito</span> ng may tamang personal na impormasyon at detalye ng pag-aadopt.
                </li>
                    </ol>
                  </div>
                </details>
                <details class="process-step" data-step="2">
                  ...
                  <div class="p-3 text-sm text-gray-700">
                    <ol class="list-decimal list-inside space-y-2 leading-7">
                <li class="pb-2 border-b border-blue-100">
                        Pagkatapos i-submit, makakatanggap ka ng <span class="font-medium">confirmation email na kailangan mong i-confirm sa loob ng 24 oras</span>.
                        <span class="text-red-400 font-medium">Ang hindi pag-confirm sa loob ng panahong ito ay awtomatikong magkakansela ng iyong aplikasyon.</span>
                </li>
                    </ol>
                  </div>
                </details>
                <details class="process-step" data-step="3">
                  ...
                  <div class="p-3 text-sm text-gray-700">
                    <ol class="list-decimal list-inside space-y-2 leading-7">
                <li class="pb-2 border-b border-blue-100">
                        Kapag na-confirm na, makakatanggap ka ng isa pang email na naglalaman ng estimated time kung gaano katagal i-prepare ang iyong ina-adopt na pet. Hintayin ang <span class="font-medium">email para sa schedule</span> bago magpatuloy.
                </li>
                    </ol>
                  </div>
                </details>
                <details class="process-step" data-step="4">
                  ...
                  <div class="p-3 text-sm text-gray-700">
                    <ol class="list-decimal list-inside space-y-2 leading-7">
                <li class="pb-2 border-b border-blue-100">
                        Kapag natanggap mo na ang email para sa schedule, kailangan mong <span class="font-medium">mag-set ng pickup date sa loob ng 48 oras</span>.
                        <span class="text-red-400 font-medium">Ang hindi pagtugon sa loob ng panahong ito ay awtomatikong magkakansela ng iyong aplikasyon.</span> Ang mga available na petsa ay sa loob ng 7 working days ng aming opisina mula sa petsa ng email.
                </li>
                    </ol>
                  </div>
                </details>
                ...
                <li class="pb-2 border-b border-blue-100">
                  ...
                  <ul class="list-disc list-inside ml-5 mt-1">
                    ...
                    <li>Ang iyong transaction confirmation email</li>
                        ...
                        <span class="text-red-400 font-medium">Ang hindi pag-pick up sa loob ng 3 working days ng aming opisina pagkatapos ng nakatakdang pickup date ay awtomatikong magkakansela ng iyong application.</span>
                </li>
                    </ol>
                  </div>
                </details>
                <details class="process-step" data-step="6">
                  ...
                  <div class="p-3 text-sm text-gray-700">
                    <ol class="list-decimal list-inside space-y-2 leading-7">
                      <li>
                        Sa oras ng pickup, kukunan ka ng <span class="font-medium">opisyal na larawan</span> kasama ang iyong bagong alaga na may hawak na adoption information board. I-popost po namin ito sa opisyal na channels ng City Information Office.
                </li>
              </ol>
                  </div>
                </details>
              ...
              <div class="space-y-2">
                <details class="process-step" data-step="1" open>
                  ...
                  <div class="p-3 text-sm text-gray-700">
                    <ol class="list-decimal list-inside space-y-2 leading-7">
                <li class="pb-2 border-b border-blue-100">
                        <span class="font-medium">Kumpletuan me ining form</span> gamit ing kekang personal a impormasyun ampo ing detalye ning kekang pamag-adopt.
                </li>
                    </ol>
                  </div>
                </details>
                <details class="process-step" data-step="2">
                  ...
                  <div class="p-3 text-sm text-gray-700">
                    <ol class="list-decimal list-inside space-y-2 leading-7">
                <li class="pb-2 border-b border-blue-100">
                        Kaybat meng i-submit, <span class="font-medium">makatanggap kang email ning kumpirmasyun a kailangan mung i-confirm kilub ning 24 oras</span>.
                        <span class="text-red-400 font-medium">Nung e ka makakumpirma keng kilub ning panaun ayni, automatic yang makansela ing kekang aplikasyun.</span>
                </li>
                    </ol>
                  </div>
                </details>
                <details class="process-step" data-step="3">
                  ...
                  <div class="p-3 text-sm text-gray-700">
                    <ol class="list-decimal list-inside space-y-2 leading-7">
                <li class="pb-2 border-b border-blue-100">
                        Nung mekumpirma ne, <span class="font-medium">makatanggap kang aliwang email</span> a ating makalageng estimated time kung angga kang kapilan ka manaya king preparation mi para keng ayampunan mung animal. <span class="font-medium">Paki-panayan mu ing email ning pamag-schedule.</span>
                </li>
                    </ol>
                  </div>
                </details>
                <details class="process-step" data-step="4">
                  ...
                  <div class="p-3 text-sm text-gray-700">
                    <ol class="list-decimal list-inside space-y-2 leading-7">
                <li class="pb-2 border-b border-blue-100">
                        Potang atanggap mu ne ing email ning pamag-schedule, <span class="font-medium">kailangan meng i-set ing pickup date kilub ning 48 oras</span>.
                        <span class="text-red-400 font-medium">Alang pakibat keng kilub ning panaun ayni, automatiku yang makansela ing kekang aplikasyun.</span> Deng available a petsa atyu la kilub ning 7 aldo a atyu kami keng office mi (e kayabe ing Sabado ampong Domingo) manibat keng petsa ning email.
                </li>
                    </ol>
                  </div>
                </details>
                ...
                <li class="pb-2 border-b border-blue-100">
                  ...
                  <ul class="list-disc list-inside ml-5 mt-1">
                    ...
                    <li>Ing kekang email ning kumpirmasyun keng transaksyon</li>
                        ...
                        <span class="text-red-400 font-medium">Nung e ka makapick up kilub ning atlung aldo a atyu kami king office mi (e kayabe ing Sabado ampong Domingo) kaybat ning kekang schedule date, automatikung yang makansela ing kekang aplikasyun.</span>
                </li>
                    </ol>
                  </div>
                </details>
                <details class="process-step" data-step="6">
                  ...
                  <div class="p-3 text-sm text-gray-700">
                    <ol class="list-decimal list-inside space-y-2 leading-7">
                      <li>
                        Keng pickup, <span class="font-medium">kuanan mi ing opisyal a litrato mu</span> kayabe ing bayung animal mung tatalan ampo ing detalye yu a makasulat keng adoption information board. I-post mi ya ini kareng opisyal a channels ning City Information Office.
                </li>
              </ol>
                  </div>
                </details>
