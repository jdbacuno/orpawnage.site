      ...
      <ul class="mt-4">
        ...
        <li class="mb-1 group">
          ...
          <ul class="pl-7 mt-2 hidden group-[.selected]:block">
            <li class="mb-4">
              <a
                href="#"
                class="text-gray-300 text-sm flex items-center before:contents-[''] before:w-1 hover:bg-yellow-500 hover:text-black hover:font-semibold group-[.active]:bg-yellow-500 group-[.active]:text-black p-2 rounded-full"
                >Manage services</a
              >
            </li>
          </ul>
        ...
        <li class="mb-1 group">
          ...
          >
            ...
            <span class="text-sm">OrPAWnage</span>
          </a>
        </li>
        <li class="mb-1 group">
          <a
    ...
    >
      ...
      >
        ...
        <ul class="flex items-center text-sm ml-4">
          ...
          <li class="text-gray-600 mr-2 font-medium">{{ Route::currentRouteName() ? ucfirst(Route::currentRouteName()) : '' }}</li>
        </ul>
        <ul class="ml-auto flex items-center">
          <li class="dropdown ml-3">
            <button type="button" class="dropdown-toggle flex items-center text-gray-900 hover:text-yellow-500 transition-colors duration-300">
              {{-- <img
                src="{{ asset('images/orpawnage-logo.png') }}"
                alt=""
              ...
              <i class="ph-fill ph-user-circle text-4xl font-thin"></i>
            ...
            >
              <li class="border-b border-b-gray-300 py-2">
                <span
                  class="flex items-center text-md font-semibold pb-0 px-4 text-gray-600"
                  >{{ Auth::user()->username }}</span
                >
                <span
                  href="#"
                  class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 truncate overflow-hidden"
              ...
              <li class="py-1">
                <form action="/logout" method="POST">
                  ...
                  <button class="flex items-center gap-2 text-sm py-1.5 px-4 text-gray-600 w-full rounded-full hover:text-black hover:bg-yellow-500 hover:font-semibold transition-colors duration-300">
