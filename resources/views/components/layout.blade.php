      ...
      <header class="absolute inset-x-0 top-0 z-50">
        ...
        >
          ...
          >
            ...
            >
              <img
                src="{{ asset('images/orpawnage-logo.png') }}"
                class="h-8"
                alt="Flowbite Logo"
              />
              <span
                class="self-center text-2xl font-semibold whitespace-nowrap text-orange-400 dark:text-white"
                >Or<strong class="text-yellow-500">PAW</strong>nage</span
              >
            </a>

            <!-- Dropdown Menu Button -->
            <div
              class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse transition duration-300"
            >
              <button
                type="button"
              ...
              >
                ...
                <svg
                  class="w-8 h-8 rounded-full bg-orange-500 hover:bg-yellow-500 transition-colors duration-300"
            ...
            >
              ...
              >
                ...
                <li>
                  <a
                    href="/"
                    class="block py-2 px-3 text-gray-900 rounded-sm md:hover:rounded-sm md:hover:bg-orange-500 md:hover:text-orange-400 md:py-1 md:hover:text-white hover:text-white hover:bg-orange-500 hover:text-white transition-colors duration-300"
                    >Home</a
                  >
                </li>
                ...
                <li>
                  ...
                  >
                    <ul
                      class="py-2 text-md text-gray-700 dark:text-gray-400 transition-colors duration-300"
                      aria-labelledby="dropdownLargeButton"
                    >
                      <li>
                        <a
                          href="/services/adopt-a-pet"
                          class="block px-4 py-2 hover:bg-orange-500 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white transition-colors duration-300"
                          >Adopt a Pet</a
                        >
                      </li>
                      <li>
                        <a
                          href="/services/surrender-an-animal"
                          class="block px-4 py-2 hover:bg-orange-500 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white transition-colors duration-300"
                          >Surrender a Pet</a
                        >
                      </li>
                ...
                <li>
                  ...
                  >
                    ...
                    >
                      ...
                      <li>
                        <a
                          href="/report/abused-stray-animal"
                          class="block px-4 py-2 hover:bg-orange-500 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white transition-colors duration-300"
                          >Abused / Stray Animal</a
                        >
                      </li>
                    </ul>
                  </div>
        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div class="md:flex md:justify-around">
            <div class="flex items-center space-x-4 mb-6 md:mb-0">
              ...
              <a href="/" class="flex items-center">
                <img
                  src="{{ asset('images/orpawnage-logo-2.png') }}"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-10">
              ...
              <div>
                ...
                <ul class="text-gray-500 dark:text-gray-400 font-medium">
                  <li
                    class="mb-4 flex items-center space-x-2 hover:text-orange-500 transition-colors duration-300"
                  >
          ...
          <div class="text-white sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex gap-x-4 mt-4 sm:justify-center sm:mt-0">
              <a
                href="#"
                class="text-gray-500 hover:text-orange-500 transition-colors duration-300 dark:hover:text-white"
                >Terms & Conditions</a
              >
              <a
                href="#"
