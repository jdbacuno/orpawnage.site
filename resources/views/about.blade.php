<x-layout>
  ...
  <section class="relative w-full h-[70vh]">
    ...
    <div
      class="absolute inset-0 flex items-center justify-center text-center px-5"
    >
      <h1 class="text-white text-5xl font-bold md:text-6xl cursor-pointer">
        About
        <span
          class="text-orange-500 tracking-widest hover:text-yellow-400 transition-colors duration-500"
        >
          Or<strong
            class="text-yellow-500 hover:text-orange-400 transition-colors duration-00"
            >PAW</strong
          >nage
        </span>
      </h1>
  ...
  <div class="bg-yellow-500">
    <section
      class="max-w-screen-xl mx-auto px-5 py-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center"
    >
      <!-- Left Content -->
      <div class="lg:pl-8">
  ...
  <section
    class="max-w-screen-xl mx-auto px-5 py-16 grid grid-cols-1 md:grid-cols-2 gap-10"
  >
    <!-- Left Side -->
  ...
  <div class="bg-black">
    <section class="max-w-screen-xl mx-auto px-5 py-16">
      ...
      <div
        class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 mt-20"
      >
        <div class="flex flex-col items-center text-center">
          <img
            src="{{ asset('images/dl1.jpg') }}"
            alt="Team Member"
