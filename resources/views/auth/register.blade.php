...
<x-auth-layout>
  ...
  <div class="relative p-6 bg-white z-1 sm:p-0">
    <div class="relative flex flex-col justify-center w-full h-screen lg:flex-row">
      <!-- Form Section -->
      <div class="flex flex-col flex-1 w-full lg:w-1/2 left-content overflow-y-auto no-scrollbar">
        <div
          class="flex flex-col justify-start sm:justify-center flex-1 w-full max-w-md mx-auto py-8 sm:py-0 px-4 sm:px-6 py-8">
          <div class="space-y-8">
            <!-- Mobile Logo -->
            ...
            <div class="space-y-2 text-center">
              ...
              <p class="text-gray-500">
                Sign up on OrPAWnage today to access our pet and animal services
              </p>
            </div>
