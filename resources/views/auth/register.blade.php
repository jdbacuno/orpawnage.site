<x-auth-layout>
   ...
   <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
    <div
      class="flex flex-col justify-center w-full h-screen py-10 lg:flex-row"
    >
      <!-- Form -->
      <div class="flex flex-col flex-1 w-full lg:w-1/2 overflow-y-auto p-8">
        <div
      ...
      <div
        class="relative hidden w-full lg:grid lg:w-1/2 bg-cover bg-center sticky top-0 h-screen"
        style="
      ...
      >
        ...
        >
          <img
            src="{{ asset('images/orpawnage-logo.png') }}"
            alt="Logo"
            class="block w-28 sm:w-32 md:w-36 lg:w-40"
          />
        </div>
      </div>
    </div>
